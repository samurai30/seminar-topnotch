 ...
 */
final class Version20190324141302 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE scape_user (id INT AUTO_INCREMENT NOT NULL, address_id INT NOT NULL, user_first_name VARCHAR(100) NOT NULL, user_last_name VARCHAR(100) NOT NULL, user_email VARCHAR(120) NOT NULL, user_contact VARCHAR(12) NOT NULL, username VARCHAR(60) NOT NULL, password VARCHAR(100) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:simple_array)\', token VARCHAR(40) DEFAULT NULL, UNIQUE INDEX UNIQ_259E5424550872C (user_email), UNIQUE INDEX UNIQ_259E5424F85E0677 (username), UNIQUE INDEX UNIQ_259E5424F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
